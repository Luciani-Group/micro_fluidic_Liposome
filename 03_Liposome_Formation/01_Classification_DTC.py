...
target_column = 'Population'  # target column name
...
output_file_path = os.path.join(output_dir, 'DTC_incremental_features_evaluation.xlsx')
...
plot_tree(model, feature_names=feature_columns, class_names=['No Formation', 'Formation'], filled=True, rounded=True)
plt.show()
